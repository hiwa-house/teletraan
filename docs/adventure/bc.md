...
??? gas-pump inline end "Gas Prices"
	|City|$/gal|
	|--------|:------:|
	| [Kirkland](https://www.costco.com/w/-/wa/kirkland/8) | $5.05 |
	| [Marysville](https://www.costco.com/w/-/wa/marysville/642) | $4.69 |
	| [Burlington](https://www.costco.com/w/-/wa/burlington/662) | $4.89 |
	| [Bellingham](https://www.costco.com/w/-/wa/bellingham/1216) | $4.69 |
	| [Squamish](https://www.piquenewsmagazine.com/gas-prices) | $7.53 |
...
|	--------	|	------------	|	-------	|	--------	|	--------	|	------- 	|
|	*TakeOut*	|	Mac/Cheese     	|	Tacos 	|	Burgers 	|	Teri Salmon |	*LeftOvers*	|
|	        	|	Broccoli    	|	Salad	|	Broccoli	|	Rice        |	   *or*   	|
|	        	|	Topping bar    	|	    	|	Chips   	|	Broccoli   	|	*DineOut*  	|
...
- [ ] [Brassneck Brewery](https://brassneck.ca/) [🧭](https://maps.apple.com/?daddr=2148+Main+St,+Vancouver,+BC+V5T+3C5,+Canada)🍺❓
- [ ] [Container Brewing](https://drinkcontainer.beer/) [🧭](https://maps.apple.com/?daddr=1216+Franklin+St,+Vancouver,+BC+V6A+1K1,+Canada)🍺❓
...
- [ ] [Kirin Seafood Restaurant](https://www.kirinrestaurants.com/menu/) [🧭](https://maps.apple.com/?daddr=Kirin+Seafood+Restaurant+(Richmond),+7900+Westminster+Hwy,+Richmond,+BC+V6X+1A5,+Canada)🍽️❓
...
- [ ] [Pizzeria Antico](https://www.pizzeriaantico.ca/) 🥡🍹❓
...
* ***Tacos***
- [ ]	taco shells, x1
- [ ]	corn/flour tortillas, x1
- [ ]	shredded cheese, 8oz
- [ ]	tinga sauce (6x tomatillos, 3x tomato, onion, garlic)
- [ ]	rotisserie chicken
- [ ]	iceberg lettuce
- [ ]	crema
- [ ]	lime
